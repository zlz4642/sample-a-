...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="/admin/board.php" class="list-group-item active">사내게시판</a>
          <a href="/admin/board2.php" class="list-group-item">광고문의게시판</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
    ...
    <div class="row text-right">
        <a href="/admin/board_write.php">게시글 작성</a>
    </div>
    <br><br>
