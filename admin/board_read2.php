  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-3 col-lg-3">
        ...
        <div class="list-group">
          <a href="board.php" class="list-group-item">사내게시판</a>
          <a href="board2.php" class="list-group-item active">견적문의게시판</a>
        </div>
      </div>
      <!-- /.col-lg-3 -->
      ...
      <div class="col-sm-9 col-lg-9">
        ...
        $page = $_GET["page"];
        $Board_content_sql = "SELECT * FROM Message WHERE No='$page'";
    ...
    <div class="container full_row">
        ...
        <div class="row">
          ...
          <div class="board-8">
           <?php 
            $c_specialty = str_replace("\r\n", "<br>", $board_data['Message']); 
            echo  $c_specialty; 
            ?>
          </div>
          <div class="w-100"></div>
          <div class="board-2">이메일</div>
          <div class="board-8"><?php echo $board_data['EmailAddress'];?> </div>
          <div class="w-100"></div> 
          <div class="board-2"> 연락처</div>
          <div class="board-8"><?php echo $board_data['PhoneNumber'];?> </div>
          <div class="w-100"></div>
        ...
        <div class="row">   
          <blockquote>              
              <a href="./board2.php" class="btn btn-info" role="button">목록</a> 
          </blockquote>
        </div>        
        </div>
    </div>
